export const en = {
  ...
  goals: {
    ...
    description: 'Set and track your financial targets and save with purpose.',
    addGoal: 'Add Goal',
    formDesc: 'Create a new financial goal.',
    nameLabel: 'Goal Name',
    namePlaceholder: 'e.g., New Car, Vacation',
    ...
    addFunds: 'Add Funds',
    addFundsDesc: 'How much did you save for this goal?',
  ...
  subscriptions: {
    title: 'Subscriptions',
    description: 'Track and manage your recurring payments and bills.',
    monthlyEstimate: 'Monthly Estimate',
    active: 'Active',
    noSubs: 'No Subscriptions Found',
    noSubsDesc: 'Add an expense and mark it as recurring to track it here.',
  },
  investments: {
    title: 'Investments',
  ...
  settings: {
    title: 'Settings',
    description: 'Manage your personal profile and app preferences',
    profile: 'Profile',
    fullName: 'Full Name',
